...
var Container = Class.extend({
    ...
    requestSendMessage: function(recipients, message) {
                ...
                $(data).dialog({
                    ...
                    open: function() {
                        ...
                        if (message && message.body) {
                            $('textarea#message').val(message.body);
                        }
                        if (message && message.title) {
                            $('input#subject').val(message.title);
                        }
                        $('#compose_send').unbind('click').bind('click', function() {
                            ...
                            if (to == '' || subject == '' || message == '') {
                                ...
                                messageDialog.html('<div class="loader"><img src="/images/loader.gif" alt="Loading.." /><br /><br />Loading..</div>');
                        ...
                        $('#compose_cancel').unbind('click').bind('click', function() {
                            messageDialog.dialog('close');
                            messageDialog.remove();
                        });
